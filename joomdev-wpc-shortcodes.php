            ...
            <div class="pros-section section">
                <div class="wp-pros-cons-img-wrap">
                    <div class="wp-pros-cons-img-container bg-green">
                        <img src="<?php echo plugins_url( JOOMDEV_WPC_DIR . '/assets/img/thumbs-up-icon.png' ); ?>" alt="thumbs-up-icon">
                    </div>
                </div>
                <?php echo $pros; ?>
            </div>
            ...
            <div class="cons-section section">
                <div class="wp-pros-cons-img-wrap">
                    <div class="wp-pros-cons-img-container bg-red">
                        <img src="<?php echo plugins_url( JOOMDEV_WPC_DIR . '/assets/img/thumbs-down-icon.png' ); ?>" alt="thumbs-down-icon">
                    </div>
                </div>
                <?php echo $cons; ?>
            </div>
