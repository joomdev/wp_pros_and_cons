        ...
        <div id="joomdev_wpc_editor_button_popup" class="">
            <div id="joomdev_wpc_editor_button_popup_inner">
                ...
                <div class="joomdev-wpc-settings-header">
                    <div class="column-left">
                        <div class="clear"></div>
                        <h3><img src="<?php echo plugins_url( JOOMDEV_WPC_DIR . '/admin/assets/images/joomdev-wpc.png' ); ?>"> <span><b>WP Pros &amp; Cons</b> <small><small>by <b><i>JoomDev</i></b></small></small></span></h3>
                        <div class="clear"></div>
                    </div>
                    <div class="column-right">
                        <a href="<?php echo JOOMDEV_WPC_MORE_THEMES_PLUGINS_URL; ?>" target="_BLANK" class="joomdev-more-themes-plugins-button"><img src="<?php echo plugins_url(JOOMDEV_WPC_DIR . '/admin/assets/images/font-awesome_4-7-0_shopping-cart_256_0_ffffff_none.png'); ?>"> More WP Themes &amp; Plugins</a>
        ...
        <script type="text/javascript">
            jQuery(function($){
                ...
                $(document).on('click', '.joomdev_wpc_save_shortcode', function(e){
                    ...
                    var shortcode_string_pros_list = '[joomdev-wpc-pros]<div class="section-title">Pros</div><ul class="joomdev_wpc_pros_list">'+shortcode_string_pros+'</ul>[/joomdev-wpc-pros]';
                    ...
                    var shortcode_string_cons_list = '[joomdev-wpc-cons]<div class="section-title">Cons</div><ul class="joomdev_wpc_cons_list">'+shortcode_string_cons+'</ul>[/joomdev-wpc-cons]';
